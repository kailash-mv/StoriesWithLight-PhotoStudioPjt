...
const ViewShow = ({ onHandleClick }) => {
  return (
    <div className="grid grid-cols-3 grid-rows-1 bg-backgroundone p-10 mb-7 pb-24">
      <p className="col-span-1 ml-32 pt-1 flex flex-col">
        ...
        <button
          ...
          className="py-3 px-3 max-w-32 rounded-md bg-accentone text-xl opacity-100 hover:opacity-70 font-light"
        >
          EXPLORE
        </button>
      </p>
      ...
      <div className="mt-10 col-span-2 flex flex-col">
        <div className="relative pl-56 pr-48 pt-24">
          <img
            src={image2}
            className="rounded-md absolute z-0 w-72 h-auto -mt-[140px] ml-80 "
            alt=""
          />
